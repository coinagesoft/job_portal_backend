...
namespace JobPortal.Infrastructure.Migrations
{
    ...
    [Migration("20260825100000_AllowReuseOfDeletedUserEmailAndMobile")]
    partial class AllowReuseOfDeletedUserEmailAndMobile
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobPortal.Domain.Entities.AdminEmailOtp", b =>
            {
                ...
                b.ToTable("AdminEmailOtps");
            });

            modelBuilder.Entity("JobPortal.Domain.Entities.AdminLoginLog", b =>
            {
            ...
            modelBuilder.Entity("JobPortal.Domain.Entities.AdminRole", b =>
            {
            ...
            modelBuilder.Entity("JobPortal.Domain.Entities.AdminUser", b =>
            {
                ...
                b.Property<string>("PermissionOverrides")
                    .HasColumnType("jsonb");
            ...
            modelBuilder.Entity("JobPortal.Domain.Entities.CandidateDocument", b =>
            {
            ...
            modelBuilder.Entity("JobPortal.Domain.Entities.CandidateProfile", b =>
            {
                ...
                b.Property<string>("GeneratedCvFileUrl")
                    .HasColumnType("text");

                b.Property<string>("GeneratedCvPublicId")
                    .HasColumnType("text");

                b.Property<DateTime?>("GeneratedCvUpdatedAt")
                    .HasColumnType("timestamp with time zone");
                ...
                b.Property<DateTime?>("MembershipPurchasedAt")
                    .HasColumnType("timestamp with time zone")
                    .HasColumnName("membership_purchased_at");
            ...
            modelBuilder.Entity("JobPortal.Domain.Entities.Homepage.HomepageDepartment", b =>
            {
                ...
                b.ToTable("homepage_departments", (string)null);
            });

            modelBuilder.Entity("JobPortal.Domain.Entities.Homepage.HomepageHero", b =>
            {
                ...
                b.ToTable("homepage_hero", (string)null);
            });

            modelBuilder.Entity("JobPortal.Domain.Entities.Homepage.HomepageIndustry", b =>
            {
                ...
                b.Property<int?>("JobCountOverride")
                    .HasColumnType("integer");
                ...
                b.ToTable("homepage_industries", (string)null);
            });

            modelBuilder.Entity("JobPortal.Domain.Entities.Homepage.HomepageLocation", b =>
            {
                ...
                b.ToTable("homepage_locations", (string)null);
            });

            modelBuilder.Entity("JobPortal.Domain.Entities.Homepage.HomepageRegistrationIndustry", b =>
            {
                ...
                b.HasKey("RegistrationIndustryId");

                b.HasIndex("DisplayOrder");

                b.ToTable("homepage_registration_industries", (string)null);
            });

            modelBuilder.Entity("JobPortal.Domain.Entities.Homepage.HomepageRole", b =>
            {
                b.Property<Guid>("RoleId")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("uuid");
                ...
                b.ToTable("homepage_roles", (string)null);
            });

            modelBuilder.Entity("JobPortal.Domain.Entities.Homepage.HomepageStatistics", b =>
            {
            ...
            modelBuilder.Entity("JobPortal.Domain.Entities.Homepage.HomepageSuggestion", b =>
            {
                ...
                b.ToTable("homepage_suggestions", (string)null);
            });
            ...
            modelBuilder.Entity("JobPortal.Domain.Entities.ItiCertificateReview", b =>
            {
                ...
                b.Property<string>("ItiCertPublicId")
                    .HasColumnType("text");
            ...
            modelBuilder.Entity("JobPortal.Domain.Entities.JobPosting", b =>
            {
                ...
                b.Property<string>("WorkingDocsRequired")
                    .HasColumnType("text");
            ...
            modelBuilder.Entity("JobPortal.Domain.Entities.LegalDocument", b =>
            {
                b.Property<Guid>("DocumentId")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("uuid");
                ...
                b.Property<DateTime?>("DraftEffectiveDate")
                    .HasColumnType("timestamp with time zone");
                ...
                b.Property<DateTime?>("PublishedEffectiveDate")
                    .HasColumnType("timestamp with time zone");
                ...
                b.HasData(
                    new
                    {
                        DocumentId = new Guid("6f2a6c2e-6a3b-4a0a-8a2e-0a6f6a2c2a01"),
                    ...
                    new
                    {
                        DocumentId = new Guid("6f2a6c2e-6a3b-4a0a-8a2e-0a6f6a2c2a02"),
            ...
            modelBuilder.Entity("JobPortal.Domain.Entities.MembershipPlan", b =>
            {
                b.Property<Guid>("PlanId")
                    .ValueGeneratedOnAdd()
                    .HasColumnType("uuid");
            ...
            modelBuilder.Entity("JobPortal.Domain.Entities.AdminUser", b =>
            {
                b.HasOne("JobPortal.Domain.Entities.AdminUser", "CreatedByAdmin")
                    .WithMany("CreatedAdmins")
                    .HasForeignKey("CreatedBy")
                    .OnDelete(DeleteBehavior.Restrict);

                b.HasOne("JobPortal.Domain.Entities.AdminRole", "Role")
                    .WithMany("AdminUsers")
            ...
            modelBuilder.Entity("JobPortal.Domain.Entities.EmployerBadge", b =>
            {
                ...
                b.HasOne("JobPortal.Domain.Entities.EmployerVerificationDocument", "VerificationDocument")
                    .WithMany("Badges")
            ...
            modelBuilder.Entity("JobPortal.Domain.Entities.Homepage.HomepageSuggestion", b =>
            {
                ...
                b.HasOne("JobPortal.Domain.Entities.User", "SubmittedByUser")
                    .WithMany()
